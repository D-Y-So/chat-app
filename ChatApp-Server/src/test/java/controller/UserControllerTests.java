...
public class UserControllerTests {
    ...
    public void toggleMuteUnmute_existingAdminUserTogglesNotExistingUserId_returnsResponseEntityBadRequest(){
        ...
        //TODO: erase this line, becuase it will not execute if the assert fails. In order to execute commands after a test, write them before assert in a LAMBDA. Then write an AfterAll function that executes a list of such lambdas in all tests
        deleteUserIfExists("email@gmail.com","some_username");
    }
